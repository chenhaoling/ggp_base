...
public class TreeNode {
    ...
    //根结点用的构造函数
    public TreeNode(Integer legalMoveNum, Boolean isMax, MachineState theState){
        this.n_k = 0;
        this.w_k = 0.0;
    ...
    //用的构造函数
    public TreeNode(Move move, Integer legalMoveNum, Boolean isMax, MachineState theState){
        this.move = move;
        this.n_k = 0;
        this.w_k = 0.0;
        this.child = new ArrayList<>();
    ...
    public MachineState getTheState() {
        return theState;
    }
    ...
    public void setTheState(MachineState theState) {
        this.theState = theState;
    }
}